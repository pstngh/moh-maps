...
OUTPUT = ROOT / "main" / "textures" / "codex_cache"
SIZE = 512
...
def main() -> None:
    ...
    painted_metal = mirror_tile(Image.open(SOURCE / "painted_metal_source.png"))

    save_tga(painted, "painted_concrete.tga")
    save_tga(
        colorize_gray(painted, (80, 83, 82), (200, 202, 195)),
        "concrete_light.tga",
    )
    save_tga(
    ...
    save_tga(brick, "brick.tga")
    save_tga(wood, "wood.tga")
    save_tga(painted_metal, "painted_metal.tga")
