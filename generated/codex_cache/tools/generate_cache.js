...
const referencePath = path.resolve(
  process.argv[2] || path.join("references", "de_cache_d.vmf")
);
const outputRoot = path.resolve(
  process.argv[3] || path.join("generated", "codex_cache")
);
const mapName = process.argv[4] || "codex_cache";
...
const targetMaterials = {
  concreteLight: {
    texture: "codex_cache/concrete_light",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  paintedConcrete: {
    texture: "codex_cache/painted_concrete",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  paintedConcreteBlue: {
    texture: "codex_cache/painted_concrete_blue",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  concreteFloor: {
    texture: "codex_cache/concrete_floor",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  concreteDark: {
    texture: "codex_cache/concrete_dark",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  asphalt: {
    texture: "codex_cache/asphalt",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  grass: {
    texture: "codex_cache/grass",
    contentFlags: 0,
    surfaceFlags: 524288,
  },
  gravel: {
    texture: "codex_cache/gravel",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  corrugatedBlue: {
    texture: "codex_cache/corrugated_blue",
    contentFlags: 0,
    surfaceFlags: 32768,
  },
  corrugatedGray: {
    texture: "codex_cache/corrugated_gray",
    contentFlags: 0,
    surfaceFlags: 32768,
  },
  metalTrim: {
    texture: "codex_cache/metal_trim",
    contentFlags: 0,
    surfaceFlags: 32768,
  },
  ceilingTile: {
    texture: "codex_cache/ceiling_tile",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  metalGrating: {
    texture: "codex_cache/metal_grating",
    contentFlags: 8192,
    surfaceFlags: 262176,
  },
  chainlink: {
    texture: "codex_cache/chainlink",
    contentFlags: 8192,
    surfaceFlags: 262176,
  },
  glass: {
    texture: "codex_cache/glass",
    contentFlags: 0,
    surfaceFlags: 4194304,
  },
  windowBacking: {
    texture: "codex_cache/window_backing",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  brick: {
    texture: "codex_cache/brick",
    contentFlags: 0,
    surfaceFlags: 0,
  },
  wood: {
    texture: "codex_cache/wood",
    contentFlags: 0,
    surfaceFlags: 16384,
  },
  paintedMetal: {
    texture: "codex_cache/painted_metal",
    contentFlags: 0,
    surfaceFlags: 32768,
  },
  sky: {
...
function materialFor(sourceMaterial) {
  ...
  if (
    /tools\/(toolsclip|toolsgrenadeclip|grenadeclip|toolshint|toolsskip|toolstrigger|toolsareaportal|toolsplayerclip|toolsblockbullets|toolsinvisibleladder)/i.test(
      material
    )
  ) {
  ...
  if (/(toolsblack|window|oldwindow)/.test(material)) {
  ...
  if (/(roof|corrugated)/.test(material)) {
...
const helperMaterial = /tools\/(toolsclip|toolsgrenadeclip|grenadeclip|toolshint|toolsskip|toolstrigger|toolsareaportal|toolsplayerclip|toolsblockbullets|toolsinvisibleladder)/i;
...
// Cache contains thousands of Source-only models. Their names do not encode
...
// Cache has one genuine rotating blue door. These collision bounds were read
...
for (const entity of sourceEntities) {
  ...
  const bounds = rotatedLocalBounds(
    origin,
    yaw,
    [-56.2491, -3.8992, -0.2552],
    [0.2491, 3.8992, 110.25]
  );
...
const worldspawn = [
  ...
  `"message" "Codex Cache"` ,
  `"ambientlight" "12 14 18"`,
  `"suncolor" "126 119 105"`,
  `"sundirection" "315 145 0"`,
  `"sundiffusecolor" "70 79 94"`,
  `"sundiffuse" "1.3"`,
...
setcvar "g_obj_alliedtext1" "Codex Cache"
