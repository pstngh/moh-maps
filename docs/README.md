...
| `codex_inferno` | Revision 3 playable recognition candidate; measured graph retained as validator, 455 complete callout-zoned village masses, correctly scaled fountain/well landmarks, full compile/light, official-radar alignment, and exact-PK3 eight-bot combat QA | Human ground-level/overview recognition review, facade windows, simplified slopes/roofs, omitted Source-only props/displacements, and unimplemented verified Source door |
