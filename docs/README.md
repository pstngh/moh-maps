...
| `codex_inferno` | Revision 2 measured clone; actual 6,997-cell/13,420-edge Inferno topology, 2,683 MOHAA-native brushes, sixteen original Mediterranean textures, budget-compliant BSP/VIS/full light, and exact-PK3 eight-bot combat QA | First human revision-2 visual review, static doors, simplified landmark/facade art, and screenshot-driven polish |
