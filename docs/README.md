...
| `codex_obj_team2_expanded` | Revision 1 stock-map expansion; original Objective graph, 23 doors, and team starts retained; connected east service annex, full compile/light, 10-view visual QA, exact Objective boot/Recast plus FFA bot combat | Human visual/door/objective-completion and balance sweep; annex is naturally closer to the Axis side and has no new objective |
