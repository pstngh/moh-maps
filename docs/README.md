...
| `codex_reactor` | Revision 1 original close-range industrial DM map; deterministic 132-brush source, eight connected zones, full retail compile/light, eight fixed renderer views, exact-PK3 Recast/eight-bot combat, and position-sampled coverage of every zone | Longer human spawn/cover/brightness tuning; intentionally simpler than Valve's Nuke and contains no moving machinery or doors |
