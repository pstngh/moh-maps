...
| `codex_inferno` | Revision 4 direct-VMF playable candidate; 5,533 playable brush solids preserved, one measured door translated, full `-notjunc` compile/light, and exact-PK3 eight-bot combat QA | Human recognition/door review, planarized displacements, 6,200 omitted Source props, possible T-junction seams, distant skybox, and 2.34 MB nominal BSP-budget overage |
