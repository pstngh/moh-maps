...
| `codex_obj_team2_expanded` | Revision 2 after user-rejected sparse/one-sided rev1; 156 fully skinned brushes, zero caulk/nodraw/alpha construction, two service sheds, preserved Objective graph/23 doors/team starts, full compile/light, 14-view visual QA, Objective plus FFA bot QA | Human revision-2 re-test, door/objective-completion and balance sweep; annex remains naturally closer to the Axis side and has no new objective |
