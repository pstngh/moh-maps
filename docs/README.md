...
| `codex_inferno` | Revision 2 technically validated but visually rejected; its 6,997-cell/13,420-edge measurement graph became a fragmented wall/roof maze rather than recognizable Inferno architecture | Replace with callout-by-callout continuous streets and complete semantic building volumes; do not polish or release revision 2 |
