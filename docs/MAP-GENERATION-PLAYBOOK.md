...
16. Interpret “remove all fencing” literally across the complete requested perimeter. Do not retain or reconstruct neighboring panels, overhead wire, curb fragments, rails, posts, caps, or playerclips unless the user explicitly asks for a partial opening. Require a source-owner inventory and a compiled regional check.
